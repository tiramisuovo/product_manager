...
import logging
from backend.crud.image_crud import add_image
from backend.crud.customer_crud import add_customer, search_by_customer
from backend.crud.tag_crud import add_tag, search_by_tag
from backend.crud.quote_crud import add_quote
from backend.crud.misc_crud import search_by_barcode, search_by_ref_num
